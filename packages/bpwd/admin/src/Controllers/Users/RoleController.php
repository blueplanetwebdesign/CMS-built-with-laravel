...
class RoleController extends Controller
{
    ...
    protected $session_prefix = 'roles.roles.';
    protected $plural = 'role';
    protected $singular = 'roles';
    ...
    public function index(PermissionField $permission_field)
    {
        ...
        AdminToolbarHelper::addSlotForToolbar(\Form::adminToolbarNewButton('roles'));
        AdminToolbarHelper::addSlotForToolbar(\Form::adminToolbarEditButton('roles'));
        ...
        return view('admin::Pages/Users/Roles', ['data' => $data, 'filters' => $this->getFilters(), 'toolbar_slots' => AdminToolbarHelper::getSlotsForToolBar(), 'list' => $list, 'html' => $html]);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $html->title = 'Users -> Role Edit';

        return view('admin::Pages/Users/Role', ['data' => $data, 'html' => $html, 'toolbar_slots' => \AdminToolbarHelper::getSlotsForToolBar()]);
    }
