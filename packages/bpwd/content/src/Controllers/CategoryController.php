...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $html = new \stdClass();
        $html->title = 'Content -> Category List';
        ...
        return view('content::Category/Categories', ['data' => $data, 'filters' => $this->getFilters(), 'toolbar_slots' => \AdminToolbarHelper::getSlotsForToolBar(), 'list' => $list, 'html' => $html]);
    }
