  ...
  <div class="caption text-center">
    <div class="btn-group">
      ...
      <ul class="dropdown-menu" role="menu">
        <li><a href="javascript:rename('{{ $file_name }}')"><i class="fa fa-edit fa-fw"></i> Rename</a></li>
        <li><a href="javascript:download('{{ $file_name }}')"><i class="fa fa-download fa-fw"></i> Download</a></li>
        <li class="divider"></li>
        @if($type == 'Images')
        <li><a href="javascript:fileView('{{ $file_name }}')"><i class="fa fa-image fa-fw"></i> View</a></li>
        {{--<li><a href="javascript:notImp()">Rotate</a></li>--}}
        <li><a href="javascript:resizeImage('{{ $file_name }}')"><i class="fa fa-arrows fa-fw"></i> Resize</a></li>
        <li><a href="javascript:cropImage('{{ $file_name }}')"><i class="fa fa-crop fa-fw"></i> Crop</a></li>
        <li class="divider"></li>
        @endif
        <li><a href="javascript:trash('{{ $file_name }}')"><i class="fa fa-trash fa-fw"></i> Delete</a></li>
      </ul>
    </div>
  </div>
</div>
