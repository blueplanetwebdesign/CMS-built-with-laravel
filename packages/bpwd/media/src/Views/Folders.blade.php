  ...
  <div class="caption text-center">
    <div class="btn-group">
      ...
      <ul class="dropdown-menu" role="menu">
        <li><a href="javascript:rename('{{ $dir_name['short'] }}')"><i class="fa fa-edit fa-fw"></i> Rename</a></li>
        <li><a href="javascript:trash('{{ $dir_name['short'] }}')"><i class="fa fa-trash fa-fw"></i> Delete</a></li>
      </ul>
    </div>
